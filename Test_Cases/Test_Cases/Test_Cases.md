Bug_Reports/Bug_report_001.md
Test_Plan/Test_Plan.md
Screenshots/READMR.md
...
---
##TC_004 - Add product to card
**Precondition:** User is logged in 
**Steps:**
1. Navigate to Products page
2. Click "Add to cart" on any product

**Expected Result:** Products addet to cart, cart count increases
**Status** Pass

---
##TC_005 - Checkout process
**Precondition:** At leas one product in cart
**Steps:**
1. Go to Card
2. Click "Checkout"
